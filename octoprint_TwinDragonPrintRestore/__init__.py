...
class TwinDragonPrintRestore(octoprint.plugin.StartupPlugin,
	...
	def get_update_information(self):
		...
		return dict(
			TwinDragonPrintRestore=dict(
				...
				type="github_release",
				user="FracktalWorks",
				repo="TwinDragonPrintRestore",
				current=self._plugin_version,
				# update method: pip
				pip="https://github.com/FracktalWorks/TwinDragonPrintRestore/archive/{target_version}.zip"
			)
		)
# endregion
...
def __plugin_load__():
	...
	__plugin_implementation__ = TwinDragonPrintRestore()
