...
plugin_identifier = "TwinDragonPrintRestore"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_TwinDragonPrintRestore"
# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "Octoprint-TwinDragonPrintRestore"
...
plugin_url = "https://github.com/FracktalWorks/TwinDragonPrintRestore"
